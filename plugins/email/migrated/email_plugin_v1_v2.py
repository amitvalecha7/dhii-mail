...
from a2ui_integration.framework.contract import PluginInterface, PluginManifest, PluginCapability, PluginType, CapabilityType, PluginType, PluginStatus, PluginConfig
...
class EmailPluginV2(PluginInterface):
    ...
    def __init__(self, db_path: str = "email_plugin.db"):
        self.db_path =         self._health_status = HealthStatus.HEALTHY
...
def register(kernel_api):
    """
    Register the email plugin with the kernel.
